    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            ...
            <div class="panel panel-default">
                ...
                <a href="<?php echo e(url('comment/del',$comment_edit->id)); ?>" class="btn btn-danger btn-xs pull-right">
                    <i class="fa fa-btn fa-trash" title="delete"></i> delete Comment
                </a>

                <div class="panel-content">
                    <form  id="main-form" method="post" action="<?php echo e(URL::Route('comment_update')); ?>" class="form-horizontal form-bordered" enctype="multipart/form-data">
