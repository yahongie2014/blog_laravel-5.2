                                ...
                                <li>
                                    <div class="vote">
                                        <div class="form-inline upvote">
                                            <a id="bL-like" href="<?php echo e(url('Vote/Up',[$item->id, Auth::user()->id])); ?>">
                                                <i class="fa fa-btn fa-caret-up  <?php echo (!empty($item->up)&& $item->up == 1)? '':'disabled' ?> upvote" title="You need to be logged in to vote"></i>
                                            </a>
                                        </div>
                                        <div class="form-inline upvote">
                                            <a id="bL-like" href="<?php echo e(url('Vote/Down',[$item->id, Auth::user()->id])); ?>">
                                    ...
                                    <div class="info">
                                        Post Vote 1 | Posted by <?php echo  $item->post_user ?> |  <a href="<?php echo e(url('/post/comment',$item->post_id)); ?>">Comment</a>
                                    </div>
                                </li>
                            <?php endforeach; ?>
                        </ul>
